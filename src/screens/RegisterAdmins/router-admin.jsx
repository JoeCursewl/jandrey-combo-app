    ...
    <View style={stylesRouter.container}>
      ...
      <View style={stylesRouter.containerArrow}>
        ...
        <TextWithColor color={"#9760B6"} fontSize={14}>
          Admins | Registro de Administradores
        </TextWithColor>
      </View>

      <View style={stylesRouter.containerButtons}>

        <Link style={stylesRouter.allLinks} to={"/register/new-post"}>
        ...
        <Link style={stylesRouter.allLinks} to={"/register/new-package"}>
          <View style={stylesRouter.containerButton}>
            <View style={stylesRouter.containerInfoLink}>
              <Image
        ...
        <Link style={stylesRouter.allLinks} to={"/register/new-trainer"}>
          <View style={stylesRouter.containerButton}>
            <View style={stylesRouter.containerInfoLink}>
              <Image
        ...
        <Link style={stylesRouter.allLinks} to={"/register/new-contact"}>
          <View style={stylesRouter.containerButton}>
            <View style={stylesRouter.containerInfoLink}>
              <Image
